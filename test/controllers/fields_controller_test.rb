...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { field_type: @field.field_type, name: @field.name } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { field_type: @field.field_type, name: @field.name } }
